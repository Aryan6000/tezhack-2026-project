    ...
    return (
      <div className="bg-gray-50 min-h-screen py-10 flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-10 max-w-md w-full text-center">
          ...
          <button onClick={() => setSuccessToken('')}
    ...
    <div className="bg-gray-50 min-h-screen py-10">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:flex items-center justify-between bg-white p-2 rounded-xl border border-gray-200 mb-8 shadow-sm">
          {[['Category & Issue Details','Step 1 • Active',true],['Location & Geo-Tagging','Step 2',false],['Photo & Verification','Step 3',false]].map(([label, sub, active], i) => (
            <div key={i} className={`flex-1 flex items-center p-3 ${active ? 'bg-blue-50 rounded-lg' : ''}`}>
              {i > 0 && <div className="w-8 mr-3"><div className="h-px bg-gray-300 w-full" /></div>}
              <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm mr-3 ${active ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-500'}`}>{i+1}</div>
              <div>
                <div className={`text-xs font-bold uppercase tracking-wider ${active ? 'text-blue-600' : 'text-gray-400'}`}>{sub}</div>
                <div className={`text-sm font-semibold ${active ? 'text-blue-900' : 'text-gray-600'}`}>{label}</div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="md:hidden flex justify-between items-center mb-8 px-2">
          {['Category','Location','Photo'].map((s, i) => (
            <div key={i} className="flex flex-col items-center flex-1">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm mb-1 z-10 ${i===0 ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-500'}`}>{i+1}</div>
              <span className={`text-xs font-${i===0?'bold':'medium'} ${i===0?'text-blue-600':'text-gray-500'}`}>{s}</span>
            </div>
          ))}
        </div>
          ...
          <form className="divide-y divide-gray-100" onSubmit={handleSubmit}>
            ...
            <div className="p-6 md:p-8 relative">
              ...
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                  <span className="text-blue-600 md:hidden">1.</span><span className="hidden md:inline">1.</span> Select Grievance Category
                </h2>
            ...
            <div className="p-6 md:p-8 relative">
              ...
              <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                <span className="text-blue-600 md:hidden">2.</span><span className="hidden md:inline">2.</span> Issue Details
              </h2>
              <div className="space-y-6">
                <div>
            ...
            <div className="p-6 md:p-8 relative">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
                <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                  <span className="text-blue-600 md:hidden">3.</span><span className="hidden md:inline">3.</span> Location & Geo-Tag
                </h2>
            ...
            <div className="p-6 md:p-8 relative">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
                <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                  <span className="text-blue-600 md:hidden">4.</span><span className="hidden md:inline">4.</span> Photographic Proof
                </h2>
            ...
            <div className="p-6 md:p-8 relative">
              <div className="absolute left-0 top-8 bottom-0 w-1 bg-blue-600 rounded-r-md hidden md:block" />
              <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                <span className="text-blue-600 md:hidden">5.</span><span className="hidden md:inline">5.</span> Citizen Contact & Privacy
              </h2>
            ...
            <div className="p-6 md:p-8 bg-gray-50 flex flex-col-reverse sm:flex-row items-center justify-between gap-4 border-t border-gray-200">
              ...
              <div className="flex gap-4 w-full sm:w-auto sm:ml-auto">
                <button type="button" className="flex-1 sm:flex-none px-6 py-3 border border-gray-300 shadow-sm text-sm font-semibold rounded-lg text-gray-700 bg-white hover:bg-gray-50">
                  Cancel
                </button>
                <button type="submit" disabled={submitting}
                  className="flex-1 sm:flex-none w-full sm:w-auto px-8 py-3 border border-transparent shadow-sm text-sm font-bold rounded-lg text-white bg-slate-900 hover:bg-slate-800 disabled:opacity-60 flex items-center justify-center gap-2">
